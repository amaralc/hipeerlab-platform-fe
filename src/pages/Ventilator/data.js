...
const data = [
  ...
  },
  {
    ...
    description: "As chapas de acrílico do protótipo experimental OxyGEN M V5, adaptado pela equipe hipeerLab, são fabricadas por corte a laser no Núcleo de Gestão e Design - Laboratório de Design e Usabilidade da UFSC.",
    imgPath: Update20200413
  },
  {
    date: "12/04/2020",
    title: "Adaptação do projeto Oxygen para transmissão direta",
    description: "Eliminação da transmissão por engrenagens e adaptação de flange formada por anéis de acrílico. A opção reduz a complexidade de montagem do protótipo e se assemelha ao conceito IP.",
    imgPath: Update20200412
  },
  {
    date: "07/04/2020",
    title: "Adoção do projeto OxyGEN",
    description: "Após avaliar e comparar outros projetos de grupos do Brasil e do mundo, optamos por adotar o projeto OxyGEN, da equipe Protofy, de Barcelona na Espanha. O projeto é um dos mais bem documentados dentre os projetos abertos (open-source) e faz uso de poucos componentes eletrônicos, assim como de sistema de acionamento com componentes altamente disponíveis no mercado brasileiro.",
    imgPath: Update20200407
  },
  {
    date: "28/03/2020",
    title: "Modelagem de conceito com came e cinto",
    description: "Desenvolvimento de modelo de automatizador de ambu baseado em rotação contínua de um came que traciona cinto através de sistema de rolos móveis.",
    imgPath: Update20200328
  },
  {
    date: "23/03/2020",
    title: "Esboço do primeiro conceito",
    description: "Desenvolvimento de modelo utilizando dreno de sucção como alternativa em situação de escassez de ambu bag.",
