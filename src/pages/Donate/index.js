        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 mb-5 ">
              ...
              <hr />
              <p>
                Nós somos engenheiros e estudantes residentes em
                Florianópolis-SC que decidiram, voluntariamente, se unir e
                buscar uma forma de ajudar nosso país no combate ao CORONAVÍRUS
                (COVID-19)!
              </p>
              <p>
                Com isso, estamos utilizando impressoras 3D para PRODUZIR e DOAR
                equipamentos de proteção para os profissionais de saúde. Você
                também pode nos ajudar nessa causa, SEM SAIR DE CASA, fazendo
                uma doação de qualquer valor para a compra de matéria-prima.
              </p>
              {/*
