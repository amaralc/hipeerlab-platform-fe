    ...
    <div className="container">
      <div className="row">
        <div className="col-md-10 mb-5 ">
          <h5>
            A iniciativa "Juntos Contra o COVID-19" do grupo hipeerLab, tem fins lucrativos?
          </h5>
          <h7>
            ...
            seja usado, será doado para núcleos de educação e saúde em forma de 
            dinheiro ou compra de equipamentos.
          </h7>
          <hr />

          <h5>É possível comprar ou revender os produtos doados pelo hipeerLab?</h5>
          <h7>Não! A venda dos produtos é expressamente proibida.</h7>
          <hr />

          <h5>Como posso doar para a iniciativa "Juntos Contra o COVID-19", do hipeerLab?</h5>
          <h7>
          ...
          <h5>Qual a quantidade máxima de protetores faciais (face
            shield) que posso solicitar?</h5>
          <h7>
            ...
            nova solicitação. Pedimos sua compreensão para que possamos atender a 
